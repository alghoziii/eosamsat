            ...
            <div class="container">
                                ...
                                <form method="POST">
                                    <div class="mb-3">
                                        <select class="form-select" name="nkendaraan">
                                            ...
                                            <option selected="" value="<?=$vplat_kendaraan?>"><?=$vplat_kendaraan?>
                                            </option>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                <input type="number" name="nplat" value="<?=$vnomor_plat ?>"
                                                    class="form-control " placeholder="Nomor Plat" />
                                            </div>
                                        </div>

                                        <div class="col">
                                            <div class="mb-3">
                                                <input type="number" name="nseri" value="<?=$vnomor_seri ?>"
                                                    class="form-control " placeholder="Nomor Seri" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                <input type="number" name="nrangka" value="<?=$vnomor_rangka ?>"
                                                    class="form-control " placeholder="Digit Terakhir 5 Nomor Rangka" />
                                            </div>
                                        </div>
              ...
              ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$data ['provinsi']?></td>
                                            <td>
                                                <a href="tambah.php?hal=edit&id=<?=$data['id_motor'] ?>"
